...
'        <button key={id} onClick={() => setActiveChatId(id)} style={{',
'            display: "block", width: "100%", textAlign: "left",',
'            padding: "9px 12px", border: "none",',
'            borderLeft: activeChatId === id ? "3px solid #0067C5" : "3px solid transparent",',
'            background: activeChatId === id ? "#e8f0fe" : "transparent",',
...
'                    {sidebarBtn(NEW_CHAT_ID, "Ny samtale")}',
...
'                        Eksempler',
'                    </div>',
'                    {EXAMPLES.map(ex => sidebarBtn(ex.id, ex.title))}',
'                </div>',
...
'                        rows={2}',
'                        style={{ flex: 1, padding: "9px 12px", borderRadius: 6, border: "1px solid #c0c0c0", fontSize: 14, resize: "none", fontFamily: "inherit", outline: "none", background: isExample ? "#f5f5f5" : "#fff", color: isExample ? "#aaa" : "#262626" }}',
'                    />',
'                    <button',
'                        onClick={handleSendMessage}',
'                        disabled={isExample || !inputText.trim()}',
'                        style={{ padding: "9px 18px", borderRadius: 6, border: "none", background: !isExample && inputText.trim() ? "#0067C5" : "#ccc", color: "#fff", cursor: !isExample && inputText.trim() ? "pointer" : "default", fontSize: 14, fontWeight: 500 }}',
'                    >',
'                        Send',
'                    </button>',
'                </div>',
